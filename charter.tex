...
\item Product Owner (PO) - El cliente y auspiciaste del proyecto.
\item Instalador - Quien instala el sistema en la tienda o reciento.
\end{itemize}
...
\item Como instalador, quiero visualizar lo que está detectando el sistema, para poder verificar que la instalación se efectuó con éxito. (8)
