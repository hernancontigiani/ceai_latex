...
\item Grupo de requerimientos asociados con el pipeline de IA:
	...
	\item El sistema debe entregar como resultado un archivo con los datos de deteccin, seguimiento y características en formato JSON.
	\end{enumerate}
\item Grupo de requerimientos asociados con el Engine:
	...
	\item El sistema debe entregar como resultado un JSON que toda la informacin de interés a ser consumida por la aplicacin web.
	\end{enumerate}
